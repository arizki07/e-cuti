                                    ...
                                    <div class="card-body">
                                        <table class="table table-striped" id="table1">
                                            ...
                                            <tbody>
                                                ...
                                                $data_cuti = $this->cuti_model->getAllCuti('id_user');

                                                // Ambil data cuti berdasarkan id_user dari model
                                                // $data_cuti = $this->cuti_model->getCutiByUserId($this->session->userdata('id_user'));
